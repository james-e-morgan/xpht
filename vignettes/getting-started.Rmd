...
```{r dev='jpeg'}
library(imager)
gridA <- system.file('extdata/gridA.gif', package='XPHT')
gridg <- system.file('extdata/gridg.gif', package='XPHT')
...
Center an image without scaling
