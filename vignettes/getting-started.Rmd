...
Our computation of the XPHT requires computing the extended persistent homology in finitely many directions. In order to compare how close two shapes are we need to compute the distance between their XPHTs. This is done entirely analogously to the method described in [Turner, Mukherjee, & Boyer (2014)](https://arxiv.org/pdf/1310.1030.pdf). We give a brief explanation here, but suggest any interested readers consult the paper as it is much more detailed and likely clearer.
